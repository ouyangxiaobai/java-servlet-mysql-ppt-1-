...
<script type="text/javascript"  src="/secondhand/fckeditor/fckeditor.js"></script>
 <script language="javascript">
 function fckinit()
 {
   var of = new FCKeditor("content");
		of.BasePath="/secondhand/fckeditor/";
		of.Height = "300";
...
<body onload="fckinit();">
<form action="/secondhand/secondhand?ac=addmixinfof" name="f1" method="post" >
