...
<BODY>
        ...
        <TR>
          <TD height=70 vAlign=center align=right>
            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
              <TBODY>
              <TR>
                <TD width="19%" height="80" rowspan="2" align="center" onClick="window.location.replace('/secondhand')" >
                ...
                <a href="zxxs.jsp?ukey=<%=Info.getUser(request).get("username") %>"><font color="#804000">我的二手交易</font></a>
                  &nbsp;
                <a href="yfdd.jsp?ukey=<%=Info.getUser(request).get("username") %>"><font color="#804000">我的购买</font></a>
                &nbsp;
                 <a href="ysdd.jsp?ukey=<%=Info.getUser(request).get("username") %>"><font color="#804000">我的销售</font></a>
                &nbsp;
        ...
        <TR>
          <TD height=160 vAlign=top width="100%">
            ...
            <img src="/secondhand/secondhand_files/background.jpg" width="799" height="160"></img>
          ...
          <TD height=34 vAlign=top>
            <TABLE width="100%" height="34" border=0 cellPadding=0 cellSpacing=0>
              ...
              <TR>
                ...
                <TD width=56 valign="top"><IMG src="/secondhand/secondhand_files/gg_zj.jpg" width=56 
                  height=34></TD>
                <TD align=left valign="middle" height="30" background=secondhand_files/gg_bj.jpg><SPAN 
                  class=css>欢迎光临本站，本站致力于大学校园闲置书籍交易事业的发展，详情请咨询
