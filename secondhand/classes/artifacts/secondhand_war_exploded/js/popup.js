...
function uploadimg()
{
pop("/secondhand/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/secondhand/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/secondhand/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/secondhand/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/secondhand/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/secondhand/js/uploaddoc.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/secondhand/js/dialogclose.gif  />';
