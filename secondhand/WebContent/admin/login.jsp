...
<HTML><HEAD><TITLE>大学闲置书籍交易系统后台管理 - 登 录</TITLE>
<META content="MSHTML 6.00.6000.16809" name=GENERATOR></HEAD>
<BODY onLoad="loginform.uname.focus();" style="    background-size: 100% 224%;" background="/secondhand/admin/images/bj.gif">


<script type="text/javascript" src="/secondhand/admin/images/popup.js"></script>
...
<P>&nbsp;</P>
<P>&nbsp;</P>
<FORM name=loginform action="/secondhand/secondhand?ac=login"
method=post>
  <table id=Table1 
...
cellspacing=0 cellpadding=0 width=380 align=center>
    <tbody>
      <tr>
        <td 
    style="PADDING-RIGHT: 3px; PADDING-LEFT: 3px; FONT-SIZE: 13px; PADDING-BOTTOM: 3px; COLOR: white; PADDING-TOP: 3px; BACKGROUND-COLOR: #7e3b32">后台登录系统　　　　</td>
      </tr>
      <tr valign=top>
        <td><img height=60 style="background-color: #ebdcb7" width=378></td>
      </tr>
      <tr>
        <td height="60" 
...
session.removeAttribute("suc");
 ...
 %>
      ...
      <tr>
        <td height="33" 
    align=right 
    style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FONT-SIZE: 13px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px">校园闲置书籍交易系统 </td>
      </tr>
    </tbody>
  </table>
