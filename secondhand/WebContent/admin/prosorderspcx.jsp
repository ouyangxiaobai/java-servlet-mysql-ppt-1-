          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 我的销售</span></td>
              </tr>
            </table></td>
            <td> 
...
&nbsp;&nbsp;购买人 &nbsp;:&nbsp; <input type=text class=''  size=20 name='uname' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;<input type=submit class='' value='查询信息' /> &nbsp; &nbsp; &nbsp; <br /></td>
      ...
      <tr bgcolor="#F3F8F7">
        <td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >购买人</td>
