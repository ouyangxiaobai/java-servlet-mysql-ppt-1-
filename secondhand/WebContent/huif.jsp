...
var ajax = new AJAX();
ajax.post("/secondhand/secondhand?ac=gethouses&louno="+louno);
...
<%
 ...
 %>
<form action="/secondhand/huif.jsp?id=<%=id %>&f=f" name="f1" method="post" >
...
%>
alert("操作成功");
parent.location.replace("/secondhand/admin/sysuser.jsp");
<%}%>
</script>
