              ...
              <TR>
                ...
                <TD vAlign=top width=390>
                  <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                    <TBODY>
                    <TR>
                      <TD background="secondhand_files/index_jj.jpg" height="45" align="left">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
width="100%">
                          <TBODY>
                          <TR>
                            <TD width=8 height="143"><IMG src="secondhand_files/index_jjz.jpg" 
                              width=8 height=143></TD>
                            <TD vAlign=top 
                            background=secondhand_files/index_jjzbj.jpg 
align=middle>
                              <TABLE border=0 cellSpacing=0 cellPadding=0 
                              width="100%">
                                <TBODY>
                            ...
                            <TD width=8><IMG src="secondhand_files/index_jjy.jpg" 
                              width=8 height=143></TD></TR></TBODY></TABLE></TD></TR>
                    <TR>
                      <TD><img src="secondhand_files/index_jjd.jpg" width=390 
                        height=12></TD>
                    </TR>
                    <TR>
                      <TD height=10></TD></TR>
                    <TR>
                      <TD height="32" background="secondhand_files/index_xw.jpg" align="left">
                ...
                <TD vAlign=top width=200>
                  <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                    <TBODY>
                    <TR>
                      <TD height="36" background="secondhand_files/index_ylm.jpg">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <TR>
                      <TD background="secondhand_files/index_ylm2.jpg" height="34" align="left">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color="white">物品分类</font></strong>
                      </TD></TR>
                    <TR>
                      <TD background=secondhand_files/index_ylmbj.jpg 
                          ...
                          <TR>
                            <TD align=middle>
                              ...
                              width=148>
                                ...
                                <a href="/secondhand/zxxs.jsp?x=x&typename=<%=ysmap.get("typename") %>">
                    ...
                    <TR>
                      <TD height=5 background=secondhand_files/index_ylmbj.jpg 
